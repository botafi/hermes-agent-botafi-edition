...
DEFAULT_CONFIG = {
    ...
    "tools": {
        ...
        # Progressive disclosure for large MCP/plugin tool surfaces.
        # OpenAI Responses hosted search is controlled separately above;
        # this Hermes bridge is the provider-agnostic fallback.
        "tool_search": {
