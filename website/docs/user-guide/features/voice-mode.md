...
ELEVENLABS_API_KEY=your-key           # ElevenLabs Scribe — paid (cloud), highest accuracy, 90+ languages
...
ELEVENLABS_API_KEY=...              # ElevenLabs Scribe (paid, highest accuracy, 90+ languages)
...
MISTRAL_API_KEY=...                # Mistral Voxtral (paid)
XAI_API_KEY=...                    # xAI Grok STT (paid)
...
| **Mistral** | `voxtral-mini-latest` | Fast (~1s) | Good | Paid | Yes |
| **xAI** | `grok-stt` | Fast (~1s) | Good | Paid | Yes |
